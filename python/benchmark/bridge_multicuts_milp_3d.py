...
if args.log:
    output_filename = "log/bridge_multicuts_milp_" + str(Nx) + "x" + str(Ny) + "x" + str(Nz) + "_" + str(hashtag_short) + ".log"
    error_filename = "log/bridge_multicuts_milp_" + str(Nx) + "x" + str(Ny) + "x" + str(Nz) + "_" + str(hashtag_short) + ".err"
...
descriptor = {
    "prefix": "result/",
    "problem name": "bridge_multicuts_milp_"+str(Nx)+"x"+str(Ny)+"x"+str(Nz)+"_"+str(hashtag_short),
    "mesh": mesh,
