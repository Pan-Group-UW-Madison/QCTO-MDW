...
output_filename = "log/output_multicuts_milp_" + str(Nx) + "x" + str(Ny) + "x" + str(Nz) + "_" + str(hashtag_short) + ".log"
error_filename = "log/error_multicuts_milp_" + str(Nx) + "x" + str(Ny) + "x" + str(Nz) + "_" + str(hashtag_short) + ".log"
...
descriptor = {
    "prefix": "result/",
    "problem_name": "beam_multicuts_milp_"+str(Nx)+"x"+str(Ny)+"x"+str(Nz)+"_"+str(hashtag_short),
    "mesh": mesh,
